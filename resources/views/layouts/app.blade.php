...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md bg-success shadow-sm">
            <div class="container">
             <img src="/manusapedia.png" alt="" height="40px">
                <a class="navbar-brand" style="margin-left:5px" href="{{ url('/home') }}">
                   <strong style="color:white">{{ config('app.name', 'Laravel') }} </strong> 
                </a>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('tampil') }}">
                                        {{ __('tampil') }}
                                    </a>
